...
/**
 * Generates synthetic face embeddings for celebrity images. This can be run as a standalone
 * application via Gradle task.
 *
 * <p>NOTE: This generates realistic synthetic embeddings (clustered with noise). For real face
 * embeddings, use ONNX model with face detection.
 */
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (CsvEntry entry : entries) {
      try {
        ...
        Celebrity celebrity =
            new Celebrity("celeb_" + entry.id, entry.name, entry.imageResource, embedding);
