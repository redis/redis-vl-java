...
class CelebrityTest {
  ...
  void testNullIdThrowsException() {
    float[] embedding = new float[512];
    assertThatThrownBy(
            () -> new Celebrity(null, "Tom Hanks", "http://example.com/image.jpg", embedding))
  ...
  void testEmptyIdThrowsException() {
    float[] embedding = new float[512];
    assertThatThrownBy(
            () -> new Celebrity("", "Tom Hanks", "http://example.com/image.jpg", embedding))
        .isInstanceOf(IllegalArgumentException.class)
  ...
  void testNullEmbeddingThrowsException() {
    assertThatThrownBy(
            () -> new Celebrity("123", "Tom Hanks", "http://example.com/image.jpg", null))
        .isInstanceOf(IllegalArgumentException.class)
  ...
  void testEquality() {
    ...
    Celebrity celeb1 =
        new Celebrity("123", "Tom Hanks", "http://example.com/image.jpg", embedding1);
    Celebrity celeb2 =
        new Celebrity("123", "Tom Hanks", "http://example.com/image.jpg", embedding2);
