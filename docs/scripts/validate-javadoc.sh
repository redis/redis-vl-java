...
echo "Validating RedisVL4J Javadoc integration..."
...
if [ "$SKIP_FILE_CHECKS" = false ]; then
    required_files=(
        ...
        "$JAVADOC_DIR/modules/core/index.html"
    )
...
if [ "$SKIP_FILE_CHECKS" = false ]; then
    important_packages=(
        "$JAVADOC_DIR/modules/core/com/redis/vl/index/package-summary.html"
        "$JAVADOC_DIR/modules/core/com/redis/vl/query/package-summary.html"
        "$JAVADOC_DIR/modules/core/com/redis/vl/schema/package-summary.html"
        "$JAVADOC_DIR/modules/core/com/redis/vl/extensions/cache/package-summary.html"
    )
...
if [ "$SKIP_FILE_CHECKS" = false ]; then
    important_classes=(
        "$JAVADOC_DIR/modules/core/com/redis/vl/index/SearchIndex.html"
        "$JAVADOC_DIR/modules/core/com/redis/vl/query/VectorQuery.html"
        "$JAVADOC_DIR/modules/core/com/redis/vl/schema/IndexSchema.html"
        "$JAVADOC_DIR/modules/core/com/redis/vl/extensions/cache/SemanticCache.html"
    )
...
echo "4. Open: docs/build/site/redisvl/current/_attachments/javadoc/aggregate/index.html"